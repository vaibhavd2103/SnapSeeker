    ...
    <Container>
      ...
      <Section>
        <Text style={GlobalStyles.discoveryQue}>
          Okay, you are looking for a marketing SnapWorker. Do you want an
          expert specific for a job?
        </Text>
        <TextInput
          placeholder="Type a marketing task"
          placeholderTextColor={Colors.darkGrey}
          style={GlobalStyles.input}
        />
        <Text style={{ ...Font.text400, color: Colors.softRed, marginTop: 30 }}>
          Not a specific job
        </Text>
        <View
          style={{
        ...
        >
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            onPress={() => {
              props.navigation.navigate("SnapWorkerBrief");
            }}
          >
